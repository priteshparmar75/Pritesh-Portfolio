    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(onPressed: () {launchUrl(Uri.parse('https://www.linkedin.com/in/pritesh-parmar-3136a2148/'));}, icon: SvgPicture.asset('assets/icons/stackoverflow.svg',height: 23,width: 23,)),
